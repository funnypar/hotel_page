...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [bath, dinner, heart, pool, wifi];
}

class $AssetsImgGen {
  const $AssetsImgGen();

  /// File path: assets/img/hotel.png
  AssetGenImage get hotel => const AssetGenImage('assets/img/hotel.png');

  /// List of all assets
  List<AssetGenImage> get values => [hotel];
}
